      ...
      <div className="flex-1 flex items-center justify-center">
        <BarChart
          ...
          series={
            <BarSeries
              colorScheme={(data) =>
                providerColors[data.key as string] || "#6b7280"
              }
              bar={<Bar />}
            />
          }
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                ...
                <span>
                  ⚡ {provider.avgTokensPerRequest.toFixed(0)} tokens/req
                </span>
              </div>
            </div>
            ...
            <div className="w-32">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400 text-right mt-1">
                {((provider.totalCost / costMetrics.totalCost) * 100).toFixed(
                  1,
                )}
                %
              </div>
      ...
      <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 text-sm text-gray-700 dark:text-gray-300">
            <strong>Cost Optimization:</strong> Using multi-LLM routing can
            reduce costs by 70%. Route simple tasks to Gemini Flash ($1/M
            tokens) and complex tasks to GPT-4o or Claude.
          </div>
        </div>
      </div>
    </div>
