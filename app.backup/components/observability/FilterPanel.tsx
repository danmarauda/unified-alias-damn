...
/**
 * FilterPanel - Event filtering controls
 *
 * Provides dropdown filters for:
 * - Session ID
 * - Source App (hivemind-v3, voice-controller, browser-validator, llm-router)
 * - Event Type (VoiceCommand, BrowserAction, LLMRoute, AgentSpawn, etc.)
 * - Squadron (data, knowledge, validation)
...
export function FilterPanel({ filters, onChange }: FilterPanelProps) {
  ...
  const filterOptions = useQuery(api.observability.getFilterOptions);
